...
extern touchgfx::GeneratedFont& getFont_calibrib_27_4bpp();
extern touchgfx::GeneratedFont& getFont_trebucit_18_4bpp();
extern touchgfx::GeneratedFont& getFont_seguisym_10_4bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_calibrib_27_4bpp()),
    &(getFont_trebucit_18_4bpp()),
    &(getFont_seguisym_10_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_calibrib_27_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_trebucit_18_4bpp());
        break;
    case 2:
        touchgfx_fonts[2] = &(getFont_seguisym_10_4bpp());
        break;
    }
}
} // namespace TypedTextDatabase
