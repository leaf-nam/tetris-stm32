...
{
    static const touchgfx::FontId DEFAULT = 0; // calibrib_27_4bpp
    static const touchgfx::FontId LARGE = 1;   // trebucit_18_4bpp
    static const touchgfx::FontId SMALL = 2;   // seguisym_10_4bpp
