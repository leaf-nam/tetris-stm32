...
/* USER CODE BEGIN PV */
osThreadId_t Engine_TaskHandle;
const osThreadAttr_t Engine_Task_attributes = {
  .name = "Engine_Task",
  .stack_size = 1024 * 8,
  .priority = (osPriority_t) osPriorityNormal,
};

osThreadId_t Sound_TaskHandle;
const osThreadAttr_t Sound_Task_attributes = {
  .name = "Sound_Task",
  .stack_size = 1024,
  .priority = (osPriority_t) osPriorityNormal,
};

osThreadId_t Sound_Effect_TaskHandle;
const osThreadAttr_t Sound_Effect_Task_attributes = {
  .name = "Sound_Effect_Task",
  .stack_size = 512,
  .priority = (osPriority_t) osPriorityNormal,
};
...
int main(void)
{
  ...
  Sound_TaskHandle = osThreadNew(Sound_Task, NULL, &Sound_Task_attributes);
  Sound_Effect_TaskHandle = osThreadNew(Sound_Effect_Task, NULL, &Sound_Effect_Task_attributes);
  ...
  sound_task_queue = xQueueCreate( SOUND_TASK_QUEUE_LENGTH, SOUND_TASK_QUEUE_SIZE );
  sound_effect_task_queue = xQueueCreate( SOUND_EFFECT_TASK_QUEUE_LENGTH, SOUND_EFFECT_TASK_QUEUE_SIZE );
